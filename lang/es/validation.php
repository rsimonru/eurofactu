...
return [
    ...
    */
    ...
    | usando la convención "attribute.rule" para nombrar las líneas. Esto hace que sea
    | rápido especificar una línea de idioma personalizada específica para una regla
    | de atributo dada.
    |
    */
    ...
    | marcador de posición de atributo con algo más amigable para el lector como
    | "Dirección de Correo Electrónico" en lugar de "email". Esto simplemente nos
    | ayuda a hacer nuestro mensaje más expresivo.
    |
    */
