...
return new class extends Migration
{
    ...
    {
        Schema::create('sales_invoices_products', function (Blueprint $table) {
            $table->id();
            $table->foreignId('sinvoice_id')->constrained('sales_invoices');
    ...
    {
        Schema::dropIfExists('sales_invoices_products');
    }
};
