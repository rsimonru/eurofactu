...
new class extends Component {
    ...
    #[Validate('nullable|boolean')]
    public bool $equivalence_surcharge = false;
    ...
    public function loadThirdpartyData(): void
    {
        ...
        $this->equivalence_surcharge = empty($thirdparty->equivalence_surcharge) ? false : $thirdparty->equivalence_surcharge;
            ...
            <div class="flex-1 lg:w-1/2">
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
                        ...
                        <flux:field>
                            <flux:label>{{ __('thirdparties.equivalence_surcharge') }}</flux:label>
                            <flux:switch wire:model="equivalence_surcharge" />
                            <flux:error name="equivalence_surcharge" />
                        </flux:field>
