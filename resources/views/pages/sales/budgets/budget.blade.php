...
new class extends Component {
    ...
    public bool $openCreateOrder = false;
    ...
    public function mount(?int $id = null): void
    {
        ...
        if ($id) {
            ...
            $this->isEditing = true;
            $this->loadBudgetData();
            foreach ($this->budget->products as $line) {
    ...
    #[Computed]
    public function selectedLinesUnits()
    {
        return $this->selected_lines_units;
    }
    ...
    public function createOrder()
    {
        ...
        $this->budget->createOrder($selected_lines_units, $this->customer_date);
...
<section class="w-full h-full">
    <x-document.layout :title="$pageTitle" :breadcrumbs="$breadcrumbs">
        ...
        <div class="flex flex-col gap-6 lg:flex-row h-full">
            <div class="w-full f-full overflow-y-auto">
                <form wire:submit="save" class="space-y-6 px-2">
                    <!-- Company & Customer -->
                    <div class="grid grid-cols-2 lg:grid-cols-6 gap-2 mb-2">
                        ...
                        <flux:tab.panel name="lines-tab" class="pt-1!">
                            <div class="space-y-4">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <flux:button size="sm" variant="primary" color="blue" wire:click="initCreateOrder" icon="file-plus" class="cursor-pointer">
                                        {{ __('sales.create_order') }}
                                    </flux:button>
                                </div>

                                @if(count($lines) > 0)
                                    <flux:table container:class="max-h-[calc(100vh-30rem)]" >
                                    ...
                                    <div class="border-t pt-4">
                                        <table class="flex justify-end">
                                            <tr>
                                                <td colspan="2" class="text-sm pr-4">{{ __('general.subtotal') }}</td>
                                            ...
                                            <tr class="border-t pt-2">
                                                <td colspan="2" class="text-lg font-bold pr-4">{{ __('general.total') }}</td>
                                            ...
                                            @if($tax_retention != 0)
                                                ...
                                                <tr class="border-t pt-2">
                                                    <td colspan="2" class="text-lg font-bold pr-4">{{ __('general.net_total') }}</td>
        ...
        <x-slot:modals>
            ...
            <flux:modal class="w-[95%]! md:w-auto! md:max-w-[50vw]!" name="create-order" wire:model.self="openCreateOrder">
                <div class="space-y-6">
                    <div>
                        <flux:heading size="lg">{{ __('sales.create_order') }}</flux:heading>
                    </div>
                    ...
                    <div class="flex gap-2">
                        <flux:spacer />
                        <flux:modal.close>
                            <flux:button size="sm" variant="primary" color="blue" wire:click="createOrder" icon="file-plus">
                                {{ __('sales.create_order') }}
                            </flux:button>
                        </flux:modal.close>
                    </div>
