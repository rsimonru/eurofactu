...
return [
    ...
    'vendorName' => env('VERIFACTU_VENDOR_NAME', 'Mediforum, S.L.'),
    'vendorVat' => env('VERIFACTU_VENDOR_VAT', 'B82540543'),
    'systemName' => env('VERIFACTU_SYSTEM_NAME', 'Gestión Mediforum'),
    'systemId' => env('VERIFACTU_SYSTEM_ID', 'GM-001'),
